...
set timeout -1
set prompts ">#|#|\$"
log_file logs/log_2020-03-24-13-51-35/10.44.72.17-20200324135141-7360i-cli.log
spawn ssh isadmin@10.44.72.17
expect "yes/no" { 
			send "yes\r"
			expect "*?assword" { send "ANS@123\r" }
			} "*?assword" { send "ANS@123\r" }
expect ">#"
